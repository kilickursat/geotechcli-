...
- Added regression coverage proving opt-in model route proposals execute only validated workflows and rejected model proposals preserve fallback behavior.
