...
- Attach standards-profile assumptions, deterministic validation blockers, safety-factor context, source references, and opt-in non-executing calculation input drafts to GroundModel readiness so downstream calculations are prepared but still review-gated.
