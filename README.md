...
| `geotech fem run` | Human-invoked experimental execution of a reviewed FEM `analysis_case.json` through deterministic preview backends, including optional staged-consolidation `--backend nonlinear-column`; requires `--experimental --reviewed` |
