  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 opacity-20" style={{
        backgroundImage: 'radial-gradient(circle at 20% 50%, rgba(45,212,191,0.15) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(59,130,246,0.1) 0%, transparent 50%)',
      }} />
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-end px-12 pb-20 max-w-[820px]">
        ...
        <p className="text-[17px] leading-[1.7] text-[var(--text-secondary)] max-w-[560px] mb-9 font-normal">
          AI-native calculations, rock &amp; soil classification, TBM prediction,
          vision-based analysis, and LLM-powered report generation — from your
          terminal. LLM-agnostic. Free tier included.
        </p>
