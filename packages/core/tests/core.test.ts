...
describe('Tool Registry', () => {
  it('All expected tools registered', () => {
    ...
    for (const n of ['calculate_bearing_capacity', 'calculate_liquefaction', 'classify_rmr89', 'classify_uscs', 'classify_q_system', 'predict_tbm_performance', 'select_tbm_type', 'predict_cutter_wear', 'calculate_tunnel_settlement', 'calculate_consolidation', 'calculate_schmertmann_settlement', 'read_file', 'list_directory', 'parse_csv', 'write_file', 'scan_project', 'run_command', 'parse_ags', 'parse_cpt', 'ingest_geotech_document', 'list_persisted_ingest_reviews', 'load_persisted_ingest_review', 'list_persisted_ingest_review_approvals', 'load_persisted_ingest_review_approval', 'approve_persisted_ingest_review', 'promote_persisted_ingest_review', 'query_standards', 'list_fem_capabilities', 'prepare_fem_analysis_case', 'validate_fem_analysis_case', 'project_create', 'project_load', 'project_list', 'project_save_dataset', 'project_save_parameter', 'project_add_assumption', 'project_add_artifact', 'project_save_result']) {
