...
export const STRONG_BETA_SKILL_APPROVALS: Record<string, StrongBetaSkillApproval> = {
  ...
  'epb-conditioning-clogging': approval('held_back', EPB_HOLD_REASON),
  'epb-face-support-window': approval('held_back', EPB_HOLD_REASON),
  'epb-production-and-ring-cycle': approval('held_back', EPB_HOLD_REASON),
  'epb-soft-ground-screening': approval('held_back', EPB_HOLD_REASON),
  ...
  'mixed-face-transition-planning': approval('held_back', EPB_HOLD_REASON),
  ...
  'soft-ground-settlement-observational-control': approval('held_back', EPB_HOLD_REASON),
