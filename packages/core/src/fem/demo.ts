...
export function runBuiltinBiotUpPlaneStrainPreview(
  ...
  const envelope = {
    ...
    averagePorePressureKpa: result.pressureDiagnostics.averagePorePressureKpa,
    averageFreePorePressureKpa: result.pressureDiagnostics.averageFreePorePressureKpa,
    porePressureDissipationRatio: result.pressureDiagnostics.porePressureDissipationRatio,
    maxPorePressureChangeRateKpaPerS: result.pressureDiagnostics.maxPorePressureChangeRateKpaPerS,
